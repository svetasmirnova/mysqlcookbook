...
INSERT INTO patients (national_id, name, surname, gender, age, diagnosis, result, date_arrived, date_departed)
  VALUES
    ...
    ('54XT916306', 'Elizabeth', 'Jones', 'F', 39, 'COVID-19', 'R', '2020-04-17', '2020-06-03'),
    ...
    ('96HE717336', 'Michael', 'Lopez', 'M', 33, 'COVID-19', 'D', '2020-09-15', '2020-09-20'),
    ('26ES505212', 'Susan', 'Gonzalez', 'F', 81, 'COVID-19', 'R', '2020-10-01', '2020-10-28'),
    ('04WT954962', 'Peter', 'Wilson', 'M', 86, 'Diabetes', 'N', '2020-09-26', '2020-10-07'),
    ('65XJ029932', 'Helen', 'Anderson', 'F', 57, 'COVID-19', 'R', '2020-10-06', '2020-10-26'),
    ('59DW008178', 'Thomas', 'Thomas', 'M', 53, 'COVID-19', 'R', '2020-09-15', '2020-10-26'),
    ('99XC682639', 'Emma', 'Taylor', 'F', 69, 'Breast Cancer', 'R', '2020-07-18', '2020-09-15'),
    ('72TY932806', 'George', 'Moore', 'M', 20, 'COVID-19', 'R', '2020-11-01', '2020-11-10'),
